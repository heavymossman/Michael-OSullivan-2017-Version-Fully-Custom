...
//SCRIPT GOES HERE
	...
	var display = {
		...
		displayStudents: function(){
			...
			var studentName = '';
			var checkbox = 'M <input type="checkbox"> T <input type="checkbox"> W <input type="checkbox"> T <input type="checkbox"> F <input type="checkbox">';
		...
		refreshtotalAttendance: function(){
